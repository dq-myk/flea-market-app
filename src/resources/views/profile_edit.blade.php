            ...
            <div class="profile-img__group">
                <div class="profile-img__inner">
                    ...
                    <div class="profile-img">
                        @if ($user->image_path)
                        <img  class = "profile-img__item" src="{{ $user->image_path }}" alt="プロフィール画像">
                        @endif
                        <p class="profile__edit__error-message">
                        @error('profile_image')
                        {{ $message }}
                        @enderror
                        </p>
                    ...
                    <div class="profile-img__select">
                        <input class="profile-img__btn" type="file" name="profile_image" accept="image/*" value = "画像を選択する">
                    </div>
                </div>
